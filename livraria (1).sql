...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Jan-2021 às 12:18
...
(14, 'rui', 'portugal', '2021-01-20 00:00:00', NULL, '2021-01-04 11:17:43', '2021-01-04 11:17:43', NULL);
...
(9, 'ruiO', 'rua a', NULL, '2021-01-04 11:06:45', '2021-01-04 11:07:01', NULL);
...
INSERT INTO `editoras_livros` (`id_el`, `id_editora`, `id_livro`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 2, NULL, NULL, NULL),
(2, 2, 1, NULL, NULL, NULL),
(3, 2, 12, '2020-12-04 16:43:52', '2020-12-04 16:43:52', NULL),
(4, 3, 12, '2020-12-04 16:43:52', '2020-12-04 16:43:52', NULL),
(5, 4, 12, '2020-12-04 16:43:52', '2020-12-04 16:43:52', NULL),
(6, 5, 12, '2020-12-04 16:43:52', '2020-12-04 16:43:52', NULL);
...
(6, 'ruio', NULL, '2021-01-04 11:16:38', '2021-01-04 11:16:52', NULL);
...
(21, 'sae', 'portugal', 2, '2021-02-03 00:00:00', '1234567890123', NULL, NULL, 1, 1, NULL, '2021-01-04 11:17:21', '2021-01-04 11:17:21', NULL, NULL);
...
--
-- Indexes for table `editoras_livros`
--
ALTER TABLE `editoras_livros`
...
--
-- AUTO_INCREMENT for table `editoras_livros`
--
ALTER TABLE `editoras_livros`
  MODIFY `id_el` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `autores_livros`
  ADD CONSTRAINT `autores_livros_ibfk_1` FOREIGN KEY (`id_autor`) REFERENCES `autores` (`id_autor`);

--
-- Limitadores para a tabela `editoras_livros`
--
ALTER TABLE `editoras_livros`
  ADD CONSTRAINT `editoras_livros_ibfk_1` FOREIGN KEY (`id_editora`) REFERENCES `editoras` (`id_editora`),
  ADD CONSTRAINT `editoras_livros_ibfk_2` FOREIGN KEY (`id_livro`) REFERENCES `livros` (`id_livro`);
COMMIT;
